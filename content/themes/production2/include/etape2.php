...
<section id="paiement">			
	...
	<label class="radiocarte" id="choixcarte">	
	...
	<form>	
		<div class="nomdetenteur"><label for="nomdetenteur"> Nom du détenteur </label>
			<input type="text" name="nom_detenteur" class="carte" id="nomdetenteur" value="<?php if (isset ($_POST['nomdetenteur'])){ echo $nomdetenteur;} ?>" required  />  
		</div>		
		<div class="nocarte"><label for="nocarte"> Numéro de la carte </label>
			<input type="text" name="nocarte" class="carte" id="nocarte" value="<?php if (isset ($_POST['nocarte'])){ echo $nocarte;} ?>" required  />  
		</div>
		<div class="expirationcarte"><label for="expirationcarte"> Expiration (mm/aa) </label>
			<input type="text" name="expirationcarte" class="carte" id="expirationcarte" value="<?php if (isset ($_POST['expirationcarte'])){ echo $expirationcarte;} ?>" required  />  
		</div>
		<div class="verifcarte"><label for="verifcarte"> No. de vérification </label>
			<input type="text" name="verifcarte" class="carte" id="verifcarte" value="<?php if (isset ($_POST['verifcarte'])){ echo $verifcarte;} ?>" required  />  
		</div>
	</form>
