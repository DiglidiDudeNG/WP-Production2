...
<div class="container">
	<div class="spectacles-a-venir-container">
		...
		<div class="spectacle-filtre">
			<!-- Liste des mois -->
			<select id="month-select" class="cs-select cs-skin-underline" onchange="location = this.options[this.selectedIndex].value;">
				...
				<?php
					...
					for($i=0; $i<12; $i++){
						...
						// Affichage en html
						echo '<option data-link="' . get_bloginfo('url') . '/programmation?selection_mois=' . $moisCourantValeur . '">' . $moisFrancaisTab[$indexTabMoisFrancais] . '</option>';
			...
			<select id="category-select" class="cs-select cs-skin-underline" onchange="location = this.options[this.selectedIndex].value;">
